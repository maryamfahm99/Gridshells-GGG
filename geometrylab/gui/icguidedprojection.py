...
from geometrylab.optimization.cguidedprojection import CGuidedProjection
...
class InteractiveCGuidedProjection(GeolabComponent):
    ...
    def __init__(self):
        ...
        self.optimizer = CGuidedProjection()
