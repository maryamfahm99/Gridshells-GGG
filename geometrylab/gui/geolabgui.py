...
class GeolabGUI(MultiSceneManager):
    ...
    def select_vertices(self):
        print("select_vertices(self)") # Maryam
        if self.select_vertices_button.checked:
            print("select_vertices geolab gui") #Maryam 
