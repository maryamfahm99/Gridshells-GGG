...
from geometrylab.vtkplot.bsplineplotmanager import BSplinePlotManager
...
class GeolabBSpline(BSplinePlotManager):
    ...
    face_plot = Str('color', label='Faces')
    ...
    def __init__(self, *args):
        BSplinePlotManager.__init__(self, *args)

        self._curve_callbacks = {'pipe': self.plot_curve,
                                 'wireframe': self.plot_wireframe_curve,
                                 'none': self.hide_curve}

        self._control_callbacks = {'pipe': self.plot_control_polygon,
                                   'wireframe' : self.plot_wireframe_polygon,
    ...
    def select_off(self):
        super(GeolabBSpline, self).select_off()
    ...
    @on_trait_change('face_color_select, edge_color_select')
    def set_color(self):
